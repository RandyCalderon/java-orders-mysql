...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query(value = "SELECT custname, custcountry, grade, openingamt, outstandingamt, paymentamt, phone, receiveamt, ordnum, advanceamount,ordamount, orddescription FROM customers c, orders o WHERE o.custcode LIKE  :id", nativeQuery = true)
